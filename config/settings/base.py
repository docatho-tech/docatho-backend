...
APPS_DIR = ROOT_DIR.path("docatho_backend")
env = environ.Env()
...
# razorpay settings
RAZORPAY_KEY_ID = env("RZP_TEST_ID", default="")
RAZORPAY_KEY_SECRET = env("RZP_TEST_SECRET", default="")
RAZORPAY_WEBHOOK_SECRET = env("RZP_WEBHOOK_SECRET", default="")
...
# 100ms app subdomain — only used to build browser-joinable prebuilt URLs
# (https://<subdomain>.app.100ms.live/meeting/<room-code>) for E2E and support.
HMS_SUBDOMAIN = env("HMS_SUBDOMAIN", default="")
...
STATIC_URL = "/static/"
STATIC_ROOT = "/var/www/docatho/static"
...
MEDIA_ROOT = str(APPS_DIR.path("static"))
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "docatho_backend.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "docatho_backend.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "docatho_backend.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "docatho_backend.users.forms.UserSocialSignupForm"}
...
REST_FRAMEWORK = {
    ...
    # explicitly opts out with permission_classes = [AllowAny] (pre-auth
    # endpoints: send-otp / verify-otp / register / admin-login / dashboard).
...
SPECTACULAR_SETTINGS = {
    "TITLE": "docatho_backend API",
    "DESCRIPTION": "Documentation of API endpoints of docatho_backend",
    "VERSION": "1.0.0",
...
# https://docs.celeryq.dev/en/stable/userguide/configuration.html#std:setting-result_extended
