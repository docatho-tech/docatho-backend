...
router.register(
    "diagnostic-bookings", views.DiagnosticBookingViewSet, basename="diagnostic-booking"
)
...
router.register(
    "support-tickets", views.SupportTicketViewSet, basename="support-ticket"
)
...
urlpatterns = [
    ...
    path(
        "doctors/<int:provider_id>/",
        views.DoctorDetailAPIView.as_view(),
        name="doctor-detail",
    ),
    ...
    path(
        ...
        views.AIPrescriptionAnalysisAPIView.as_view(),
        name="ai-prescription",
    ),
    path(
        "provider/doctor-profile/",
        views.ProviderDoctorProfileAPIView.as_view(),
        name="provider-doctor-profile",
    ),
    path(
        "provider/availability/",
        views.ProviderAvailabilityAPIView.as_view(),
        name="provider-availability",
    ),
    path(
        "provider/appointments/",
        views.ProviderAppointmentListAPIView.as_view(),
    ...
    path(
        ...
        views.AdminDashboardStatsAPIView.as_view(),
        name="admin-dashboard-stats",
    ),
    path(
        "admin/patients/",
        views.AdminPatientListAPIView.as_view(),
        name="admin-patients",
    ),
    path(
        "admin/patients/<int:pk>/",
        views.AdminPatientDetailAPIView.as_view(),
        name="admin-patient-detail",
    ),
    path(
        "admin/doctors/", views.AdminDoctorListAPIView.as_view(), name="admin-doctors"
    ),
    path(
        "admin/doctors/<int:pk>/",
        views.AdminDoctorDetailAPIView.as_view(),
        name="admin-doctor-detail",
    ),
    path(
        "admin/doctors/<int:pk>/verify/",
        views.AdminDoctorVerificationAPIView.as_view(),
        name="admin-doctor-verify",
    ),
    path(
        "admin/diagnostic-bookings/",
        views.AdminDiagnosticBookingViewSet.as_view({"get": "list"}),
        name="admin-diagnostic-bookings",
    ),
    path(
        "admin/diagnostic-bookings/<int:pk>/",
        views.AdminDiagnosticBookingViewSet.as_view(
            {"get": "retrieve", "patch": "partial_update", "delete": "destroy"}
        ),
        name="admin-diagnostic-booking-detail",
    ),
