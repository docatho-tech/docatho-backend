...
def _cart_with(user, medicine, qty=1):
    # Checkout now refuses an order with no deliverable address, so a user who
    # is about to check out needs one. Raipur by factory default.
...
def test_serviceable_pincode_accepts_only_raipur():
    ...
    name in every spelling and case.
    """
